...
class NodeTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function propertiesProvider()
    {
        return [
            ...
            ['value', 'testValue'],
            ['value', ['pre' => function() { $this->target->setName('test Name'); }, 'value' => '', 'expect' => 'test-name']],
            ['value', ['pre' => function() { $this->target->setName('test Name'); }, 'ignore_setter' => true, 'value' => 'test-name']],
            ['priority', 12],
