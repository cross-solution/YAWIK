...
//: ./src/Core/Form/FormSubmitButtonsFieldset.php:41
translate('Cancel');
...
//: ./src/Core/Form/PermissionsFieldset.php:72
translate('View');

//: ./src/Core/Form/PermissionsFieldset.php:73
translate('Write');

//: ./src/Core/Form/Element/Rating.php:29
translate('Not Rated');

//: ./src/Core/Form/Element/Rating.php:37
translate('Poor');

//: ./src/Core/Form/Element/Rating.php:38
translate('Bad');

//: ./src/Core/Form/Element/Rating.php:39
translate('Average');

//: ./src/Core/Form/Element/Rating.php:40
translate('Good');

//: ./src/Core/Form/Element/Rating.php:41
translate('Excellent');
...
//: ./src/Core/Form/FileUploadFactory.php:138
